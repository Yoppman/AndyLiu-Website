  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative h-[600px] bg-white">
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-[-30px] bg-white p-8 shadow-lg max-w-[500px] mx-6">
          <p className="font-playfair text-2xl italic leading-relaxed">
            "In every hidden corner of the earth, I honor the story woven behind the scene—not only the scene itself."
          </p>
        </div>
      </section>
